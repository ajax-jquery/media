...
const ALLOWED_DOMAINS = ["assets.inviee.id","hi.inviee.id","library.eltemplate.vip", "undanganhub.com","walimatul.id","web.galeriundanganofficial.com","lovelisseinvitation.my.id","zehaninv.id","rawcdn.githack.com"];////[cite: 3]
